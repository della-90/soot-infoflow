...
public class InfoflowConfiguration {
	...
	public enum CallgraphAlgorithm {
		AutomaticSelection, CHA, VTA, RTA, SPARK, OnDemand
	}
	 ...
	 * possible when deriving new taints
	 * 
	 * @param useTypeTightening
	 *            True if the runtime type information shall automatically be
	 *            tightened when deriving new taints, otherwise false
	 */
	...
	public void printSummary() {
		...
		logger.info("Running with a maximum access path length of {}",
				getAccessPathLength());
